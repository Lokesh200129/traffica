...
import type { BillingTransaction, TransactionType } from "../_lib/mock-data-type";
...
export default function BillingHistory({ initialData = MOCK_TRANSACTIONS }: BillingHistoryProps) {
